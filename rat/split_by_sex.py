...
#group file
exposeGroup = pd.read_table('/ifshk5/BC_COM_P11/F17HTSCCWLJ1810/RATdkdM/Sample_information_detail.xls', header=0, index_col=0)
recoveryGroup = pd.read_table('/ifshk5/BC_COM_P11/F17HTSCCWLJ1810/RATdkdM/2_Sample_information_detail.xls', header=0, index_col=0)
...
# output
FexposeDiversity.to_csv('Outdir/FexposeDiversity.txt', sep='\t')
MexposeDiversity.to_csv('Outdir/MexposeDiversity.txt', sep='\t')
FrecoveryDiversity.to_csv('Outdir/FrecoveryDiversity.txt', sep='\t')
MrecoveryDiversity.to_csv('Outdir/MrecoveryDiversity.txt', sep='\t')
